...
You can save data locally to your computer by just giving the local path to the `saveData()` functoin.
...
| [ShinyPsych - Delay Discounting](ShinyPsych_DD.html "Delay Discounting")                   | A short guide on implementing the BART using ShinyPsych.                         |
| [Implementing the Delay Discounting task - a tutorial](ShinyPsych_DDCode.html "Delay Discounting") | Full code tutorial on implementing the BART using ShinyPsych.           |
