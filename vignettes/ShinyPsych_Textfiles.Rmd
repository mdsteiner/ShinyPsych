...
**dateInput**. Date input. Opens a little date panel when clicked, from which the date can be selected. Min and Max values can be set. A default value can be set in the placeholder variable
```{r, echo=FALSE}
temp.df <- tags.df[10,]
knitr::kable(temp.df, row.names = FALSE)
```
