---
title: "How to Create a File with a Questionnaire for ShinyPsych"
...
Ok let's read in the first file. Note that you can also execute this code to read in the file in your R session, given that you have installed ShinyPsych. [Here's the app in which these two lists are used](placeholder "Survey Example").
...
All examples are wrapped in code. You can use these examples as templates by just copying the respective row and then changing it.
