---
title: "Implementing DfE Task using ShinyPsych - A Tutorial"
...
This tutorial shows you how to implement the Decisions from Experience (DfE) task in a shiny app using the ShinyPsych package. If you haven't already, download the package from CRAN by running this code:
...
In this tutorial, we will show you a DfE implementation. Piece by piece we will go through the whole app code, with comments and explanations between the pieces. To see the app working, click [here](placeholder "DfE App").
