...
Shiny.addCustomMessageHandler("envDfeTwoOpts",
	function(message){
...
function enableDecisionTwoOpt(makeDecision, elmt1, elmt2){
...
function updateDfeTwoOpts(elmtG, elmtGO1, dist, distd1, ind, sam, outcome, samples,
