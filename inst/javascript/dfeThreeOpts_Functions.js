...
Shiny.addCustomMessageHandler("envDfeThreeOpts",
	function(message){
...
function enableDecisionThreeOpt(makeDecision, elmt1, elmt2, elmt3){
...
function updateDfeThreeOpts(elmtG, elmtGO1, elmtGO2, dist, distd1, distd2, ind, sam, outcome, samples,
