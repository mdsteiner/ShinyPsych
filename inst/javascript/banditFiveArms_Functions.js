...
Shiny.addCustomMessageHandler("envBanditFiveArms",
	function(message){
...
all the server to client communication in this experiment */
		...
		// number of digits to round points to
...
function updateBanditFiveArms(elmtG, elmtGO1, elmtGO2, elmtGO3, elmtGO4, elmtP, elmtC, dist, distd, distdd, distddd, distdddd,
	ind, sel, outcome, outcomeCum, selection, nTrials, gameNr, respTime, trial, t, clickEnabled, nDigits){
