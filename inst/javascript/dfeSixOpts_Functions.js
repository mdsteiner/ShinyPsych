...
Shiny.addCustomMessageHandler("envDfeSixOpts",
	function(message){
...
all the server to client communication in this experiment */
		...
		// get array of values for environment 5
		enFive = json.enFive;

		// get array of values for environment 6
		enSix = json.enSix;
...
function enableDecisionSixOpt(makeDecision, elmt1, elmt2, elmt3, elmt4, elmt5, elmt6){
	...
	var element5 = document.getElementById(elmt5);
	var element6 = document.getElementById(elmt6);
...
function updateDfeSixOpts(elmtG, elmtGO1, elmtGO2, elmtGO3, elmtGO4, elmtGO5, dist, distd1, distd2, distd3, distd4,
	distd5, ind, sam, outcome, samples, gambleNr, respTime, trial, t, clickEnabled, signalColors, makeDecision,
	...
	if (makeDecision[makeDecision.length -1] != true){
		...
		if (clickEnabled[clickEnabled.length - 1] === 1){
			...
			var otherelement4 = document.getElementById(elmtGO4);
			var otherelement5 = document.getElementById(elmtGO5);
			...
			if (samples[samples.lenth] != sam){
				...
				otherelement4.innerHTML = ' ';
				otherelement5.innerHTML = ' ';
			}
