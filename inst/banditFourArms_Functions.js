...
Shiny.addCustomMessageHandler("envBanditFourArms",
	function(message){
...
all the server to client communication in this experiment */
		...
		// number of digits the total points should be rounded to
...
function updateBanditFourArms(elmtG, elmtGO1, elmtGO2, elmtGO3, elmtP, elmtC, dist, distd, distdd, distddd,
